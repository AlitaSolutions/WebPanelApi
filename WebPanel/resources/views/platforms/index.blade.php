...
@section('content')
                ...
                <div class="eight wide column">
                    ...
                    <div class="form ui">
                        <div class="inline field">
                            ...
                            <input required type="text" placeholder="Platform Name" name="name">
    ...
    <div id="DeleteModal" class="ui mini modal">
        <div class="content">
            <p>Are you sure that you want to delete this platform?</p>
        </div>
        <div class="actions">
    ...
    <div id="EditModal" class="ui small modal">
        ...
        <div class="content">
            <div class="form ui">
                <div class="inline field">
                    <label>Platform Name : </label>
                    <input type="text" placeholder="Platform Name" name="name" id="edit">
                </div>
            </div>
        </div>
        <div class="actions">
